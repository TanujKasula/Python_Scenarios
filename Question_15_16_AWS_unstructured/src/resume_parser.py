...
def parse_resume(file_path:str) -> dict:
    ...
    txt_dir = os.path.join(os.path.dirname(os.path.dirname(__file__)), "parsed_resumes")
        ...
        if not data["email"]:
            ...
            if email_match:
                ...
                for back in range(1,5):
                    ...
                    if (possible_name and possible_name.istitle() and possible_name.replace(" ","").isalpha()) or (possible_name and possible_name.replace(" ","").isalpha()):
